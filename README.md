# Проект представляет собой кейс автоматизации тестовых сценариев на примере онлайн магазина спортивных товаров primekraft.ru<br>

> primekraft.ru — онлайн магазин спортивных товаров основанный в г.Санкт-Петербург,<br>основное преимущество это собственное производство, которое ничем не хуже западных аналогов, а возможно даже лучше.
